...
export const ui = {
  es: {
    ...
    'hero.subtitle': 'Arreglos florales artesanales en Torrevieja',
  ...
  en: {
    ...
    'hero.subtitle': 'Handcrafted floral arrangements in Torrevieja',
